...
// TODO:
// https://github.com/messari/substreams/blob/acabd16f311f05f4fe2cb910aff4efbc5e22602c/erc721/src/lib.rs
// https://github.com/streamingfast/substreams-ethereum/blob/develop/core/src/pb/sf.ethereum.type.v2.rs
        ...
        transfers: blk
            ...
            .map(|(transfer, log)| {
                ...
                erc721::Transfer {
                    ...
                    // cast log.address() , through a raw pointer first to avoid a copy
